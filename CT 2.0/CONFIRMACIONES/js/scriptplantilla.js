...
$(document).ready(function(){
  $('input.autocomplete-xray').autocomplete({
    data: {
        ...
        , 'XRAY TMJ': null, 'XRAY T-SPINE': null, 'XRAY T-SPINE 2 VIEWS': null, 'XRAY UPPER GI W/KUB': null, 'XRAY WRIST 2 VIEWA': null, 'XRAY WRIST COMPLETE (MIN 3 VIEWS)': null, '24 HR HOLTER': null, 'EKG': null, 'ECHO W/ COLOR FLOW': null
    }
  });
});
  ...
  function addtext(){
    document.addEventListener('click',
      function(){
        ...
        if(radio43.checked){
          document.getElementById('label43').innerHTML = radio43.value;
          
        }
        
  
        if(radio44.checked){
          document.getElementById('label44').innerHTML = radio44.value;
          
        }
        
        if(radio45.checked){
          document.getElementById('label45').innerHTML = radio45.value;
          
        }
  
        if(radio46.checked){
          document.getElementById('label46').innerHTML = radio46.value;
          
        }
        
        if(radio47.checked){
          document.getElementById('label47').innerHTML = radio47.value;
          
        }
  
        if(radio48.checked){
          document.getElementById('label48').innerHTML = radio48.value;
          
        }
  
        if(radio49.checked){
          document.getElementById('label49').innerHTML = radio49.value;
          
        }
  
        if(radio50.checked){
          document.getElementById('label50').innerHTML = radio50.value;
          
        }
  
        if(radio51.checked){
          document.getElementById('label51').innerHTML = radio51.value;
          
        }
  
        if(radio52.checked){
          document.getElementById('label52').innerHTML = radio52.value;
          
        }
  
        if(radio53.checked){
          document.getElementById('label53').innerHTML = radio53.value;
...
function addInputText5MRI(){
  var ptneeds2 = document.getElementById('ptneeds2');
  var ptneeds1 = document.getElementById('specilneedno');
	document.addEventListener('change',
		function(){
...
function addtextUS(){
  document.addEventListener('click',
    function(){
      ...
      var radio40=document.getElementById('r40');
      var nar41=document.getElementById('nar20');
      var radio41=document.getElementById('r41');
      var nar42=document.getElementById('nar42');
      var radio42=document.getElementById('r42');
      var radio43=document.getElementById('r43');
      var radio44=document.getElementById('r44');
      var radio45=document.getElementById('r45');
      ...
      if(radio9.checked){
        document.getElementById('label9').innerHTML = radio9.value;
        
      }

      if(radio10.checked){
        document.getElementById('label10').innerHTML = radio10.value;
        
      }


      if(radio11.checked){
        document.getElementById('label11').innerHTML = radio11.value;
        
      }


      if(radio12.checked){
        document.getElementById('label12').innerHTML = radio12.value;
        
      }


      if(radio13.checked){
        document.getElementById('label13').innerHTML = radio13.value;
        
      }

      if(radio14.checked){
        document.getElementById('label14').innerHTML = radio14.value;
      ...
      if(radio40.checked){
        document.getElementById('label40').innerHTML = radio40.value;
        
      }
      

      if(radio41.checked){
        document.getElementById('label41').innerHTML = radio41.value;
        
      }
      
      if(radio42.checked){
        document.getElementById('label42').innerHTML = radio42.value;
...
/**************US FINAL ********/
    function gene(){
      ...
      document.getElementById('textarea1').innerHTML = p11+p7 + p1 + p43 + p42 +  p54 + p55 + p23 + p24 + p26 + p52 +  p27 + p15 + p6 +  p12 + p13 + p14  + p16 + p17 + p38 + p18
    ...
    function geneUS(){
      ...
      document.getElementById('textarea1').innerHTML = p1 + p2 + p4 + p6 + p7 + p8 + p9+ p10+p11+p12+p13+p14+ p16 + p40+p41+p42+p43+p44+p45+p46+p47+p48+p49+p50 ;
    ...
    function geneCT(){
      ...
      var p54 = document.getElementById('label54').innerHTML;
      var p55 = document.getElementById('label55').innerHTML;
      document.getElementById('textarea1').innerHTML =  p8 + p16 + p12 + p54 + p55+p9+p10+ p18 + p4 + p20 + p1 + p5 + p6 + p7+p11 + p17 + p2 + p3 + p19 + p13 + p14 +p15+p43+p44+p45+p46+p47+p48+p49+p50+p51+p52+p53;
    ...
    function geneMMO(){
      ...
      document.getElementById('textarea1').innerHTML =  p7 + p27+ p1 + p2 + p3  + p9 + p8 +  p11 + p13 + p22 + p24 +  p16 + p23  + p25 +p26 +p19 + p40 +p41 +p42 + p43 + p44 + p45 + p46 + p47 +p48+p49+p50;
    ...
    document.addEventListener('click',
      function(){
        ...
        if (radio14.checked){
          ...
          document.getElementById('label 14').innerHTML = radio14.value;
        }
